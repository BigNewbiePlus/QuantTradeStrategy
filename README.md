...
# 4:量化对冲策略
量化的字面含义其实表明是对收益和风险进行数量化建模管理。通常是结合“对冲”俩字一起使用。量化对冲策略即同时利用量化手段和对冲技巧的投资策略。经典的量化对冲策略有市场中性策略、事件驱动套利策略三种。<br>
4.1: [主要策略图示](/strategy/国内量化对冲主要策略.md)<br>
4.2: [市场中性策略](/strategy/市场中性策略.md)<br>
4.3: [套利策略](/strategy/套利策略.md)<br>
